...
class MissingExchangeRateError(Exception):
    ...
    def xǁMissingExchangeRateErrorǁ__init____mutmut_orig(self, c1: Currency, c2: Currency) -> None:
        super().__init__(f"{c1.value}->{c2.value}")
    def xǁMissingExchangeRateErrorǁ__init____mutmut_1(self, c1: Currency, c2: Currency) -> None:
        super().__init__(None)
